...
export const Header = ({
  ...
  return (
    <header className="w-full h-28 items-center backdrop-blur-md z-50">
      <div
        className={cn(
          "w-[95%] h-full mx-auto flex justify-between items-center"
        )}>
        <div className="flex items-center gap-3 whitespace-nowrap">
          ...
          <div
            className={cn(
              "hidden flex-[2] md:flex",
              false ? "font-normal" : "font-semibold"
            )}>
            <div className="md:flex w-[80%] mx-auto justify-between items-center capitalize text-sm ">
              <NavLink className="" href={`/${userType}/home`}>
                {({ isActive }) => (
                  <div
                    className={cn(
                      "px-6 py-3  hover:bg-brand-7/40 rounded-md transition-all duration-200",
        ...
        <div className="hidden md:flex items-center gap-3">
          <NavLink
            className=""
            href={`/${userType}/notifications/all-notifications`}>
            {({ isActive }) => (
              <div
                className={cn(
        ...
        <div className="flex items-center">
          <div className="flex items-center gap-2">
            ...
            <div className="hidden md:flex flex-col">
              <span className="text-lg font-semibold ">Hello, {fullName || user.fullName} 👋</span>
        ...
        <div className="hidden lg:flex_ items-center justify-between gap-2 flex-[1] w-[80%] mx-auto">
